...
export const Route = createFileRoute("/solar-roi/")({
  validateSearch: zodValidator(combinedSearchParamsSchema),
  component: SolarRoiComponent,
});
...
function SolarRoiComponent() {
  ...
  const handleGuideComplete = useCallback(
    (guideAnswers: Record<string, string | number>) => {
      ...
      navigate({ to: "/solar-roi", search: paramsToNavigate, replace: true });
  ...
  const handleGoBack = () => {
    ...
    // Clear all search params and stay on the solar-roi route to restart the guide
    navigate({ to: "/solar-roi", search: {}, replace: true });
